...
module YogoAuthz
  module AuthorizationSystem
    ...
    def self.included(base)
      ...
      base.send :class_inheritable_accessor, :declaired_authz
      base.send :declaired_authz=, false
    ...
    module AuthorizationSystemClassMethods
      ...
      def require_authorization(type, values, options = {})
        ...
        unless self.declaired_authz ||= false
          self.declaired_authz = true
        end
    ...
    def has_db_permissions?(controller, action)
      !YogoAuthz::Permission.all(:controller_name => controller,

...
class Yogo::RequirementsController < ApplicationController
  unloadable
  ...
  def index
    @controllers = Yogo::Controller.undeclaired_authentications
  ...
  def add_user
    @requirement = Yogo::Requirement.get(params[:id])
